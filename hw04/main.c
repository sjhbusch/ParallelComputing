...
Create PDF: a2ps main.c --pro=color --columns=2 -E -o hw04.ps | ps2pdf hw04.ps
...
#define LOOP_MAX 1.5e12 // Max iterations to take an hour
...
int main( )
{
    ...
    // ###################### Problem 2 ####################################
    // Define vector of values for problem 2
