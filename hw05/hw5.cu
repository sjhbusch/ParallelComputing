 ...
 * nvcc -O3 -gencode arch=compute_61,code=sm_61 -o hw5.exe  hw5.cu -lm
 ...
 * Compress: tar czvf Hinnebusch_hw5.tar.gz hw05/
 */
...
int main(INT argc, char *argv[])
{
    ...
    float gpu_elapsedTime; // type float, precision is milliseconds (ms) !!!
